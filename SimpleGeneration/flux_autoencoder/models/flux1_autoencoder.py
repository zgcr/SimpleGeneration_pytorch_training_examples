"""
https://github.com/MikeSirchuk/flux1/blob/main/src/flux/modules/autoencoder.py
"""
...
# FLUX.1-dev/FLUX.1-schnell/FLUX.1-Fill-dev/FLUX.1-Kontext-dev
# FLUX.1-dev/FLUX.1-schnell/FLUX.1-Fill-dev/FLUX.1-Kontext-dev四个模型的AutoEncoder模型权重实际上是一模一样的
# inplanes=3,
# planes=128,
# planes_mult=[1, 2, 4, 4],
# res_block_nums=2,
