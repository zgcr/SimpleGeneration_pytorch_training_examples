...
if __name__ == '__main__':
    ...
    # /root/autodl-tmp/pretrained_models/flux2_pytorch_official_weights/FLUX.2-dev-ae.safetensors

    saved_model_path = '/root/autodl-tmp/pretrained_models/flux2_pytorch_official_weights/FLUX.2-dev-ae.safetensors'
    ...
    torch.save(
        convert_dict,
        f'/root/autodl-tmp/pretrained_models/flux2_convert_from_pytorch_official_weights/{save_model_name}_convert_from_pytorch_official_weight.pth'
    )
