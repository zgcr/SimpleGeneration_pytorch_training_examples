...
class ILSVRC2012Dataset(Dataset):
    ...
    def __init__(self, root_dir, set_name='train', transform=None):
        ...
        sub_class_name_list = []
        for per_sub_class_name in tqdm(os.listdir(set_dir)):
...
if __name__ == '__main__':
    ...
    from SimpleGeneration.flux_autoencoder.common import Opencv2PIL, PIL2Opencv, FLUXResize, FLUXRandomPad, TorchRandomHorizontalFlip, TorchMeanStdNormalize, FLUXTrainCollater
    ...
    ilsvrc2012traindataset = ILSVRC2012Dataset(
        ...
        transform=transforms.Compose([
            Opencv2PIL(),
            FLUXResize(resize=256),
            FLUXRandomPad(resize=256),
    ...
    collater = FLUXTrainCollater(resize=256)
