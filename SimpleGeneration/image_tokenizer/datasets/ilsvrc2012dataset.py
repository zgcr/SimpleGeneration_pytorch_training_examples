...
if __name__ == '__main__':
    ...
    from SimpleGeneration.image_tokenizer.common import Opencv2PIL, PIL2Opencv, RandomCropForVQGAN, TorchRandomHorizontalFlip, TorchMeanStdNormalize, ClassificationCollater
    ...
    ilsvrc2012traindataset = ILSVRC2012Dataset(
        ...
        transform=transforms.Compose([
            Opencv2PIL(),
            RandomCropForVQGAN(resize=256, crop_fraction_range=[0.8, 1.0]),
