"""
https://github.com/FoundationVision/LlamaGen/blob/main/tokenizer/tokenizer_image/vq_loss.py
"""
    ...
    def forward(self,
        ...
        if loss_type == 'generator_loss':
            ...
            generator_adversarial_loss = self.generator_adversarial_loss(
                generator_fake)
            generator_adversarial_loss = self.generator_adversarial_weight * generator_adversarial_loss
