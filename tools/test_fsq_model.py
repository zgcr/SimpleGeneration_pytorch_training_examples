...
from tools.image_tokenizer_scripts import test_fsq_model
from tools.utils import get_logger, set_seed


def parse_args():
    parser = argparse.ArgumentParser(description='PyTorch FSQ Testing')
...
def main():
    ...
    result_dict = test_fsq_model(test_loader, model, config)
