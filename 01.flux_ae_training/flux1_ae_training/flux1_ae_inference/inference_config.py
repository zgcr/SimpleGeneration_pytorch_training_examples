...
class config:
    ...
    trained_model_path = '/root/autodl-tmp/pretrained_models/flux1_convert_from_pytorch_official_weights/FLUX.1-dev-ae_convert_from_pytorch_official_weight.pth'
