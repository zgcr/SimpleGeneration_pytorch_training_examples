...
class config:
    ...
    trained_generator_model_path = '/root/autodl-tmp/pretrained_models/ernie_image_convert_from_pytorch_official_weights/ernie_image_vae_convert_from_pytorch_official_weight.pth'
